package com.doubleclick.doctorapp.android.Home.Calender
...
import com.doubleclick.calenderview.*
import com.doubleclick.calenderview.core.*
import com.doubleclick.doctorapp.android.R
import com.doubleclick.doctorapp.android.databinding.CalenderFragmentBinding
import com.doubleclick.doctorapp.android.databinding.Example1CalendarDayBinding
import java.time.DayOfWeek
import java.time.LocalDate
import java.time.YearMonth

class CalenderFragment : BaseFragment(R.layout.calender_fragment),
    HasToolbar {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = CalenderFragmentBinding.bind(view)
        val daysOfWeek = daysOfWeek()
        binding.legendLayout.root.children
            .map { it as TextView }
            .forEachIndexed { index, textView ->
                textView.text = daysOfWeek[index].name
//                    .displayText()
    ...
    private fun updateTitle() {
        ...
        if (isMonthMode) {
            ...
            binding.exOneMonthText.text = month.month.name
//                .displayText(short = false)
        } else {
            ...
            if (firstDate.yearMonth == lastDate.yearMonth) {
                ...
                binding.exOneMonthText.text = firstDate.month.name
//                    .displayText(short = false)
            } else {
                binding.exOneMonthText.text =
                    firstDate.month.name + " - "
//                        .displayText(short = false) + " - " +
                lastDate.month.name
//                        .displayText(short = false)
