package com.doubleclick.doctorapp.android.views.videoView.fallback.video
...
import com.devlomi.fireapp.views.videoView.fallback.FallbackMediaPlayerImpl
...
class NativeVideoPlayer(
    ...
    private fun getAudioAttributes(
        @C.AudioUsage usage: Int,
        @C.AudioContentType contentType: Int
    ): AudioAttributes {
