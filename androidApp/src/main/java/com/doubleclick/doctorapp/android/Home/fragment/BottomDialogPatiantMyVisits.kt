...
import com.doubleclick.doctorapp.android.Adapters.MyVisitsAdapter
...
class BottomDialogPatiantMyVisits(val patientMyVisitsModel: List<MyVisitsModel>) :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvBooking.adapter = MyVisitsAdapter(patientMyVisitsModel)
