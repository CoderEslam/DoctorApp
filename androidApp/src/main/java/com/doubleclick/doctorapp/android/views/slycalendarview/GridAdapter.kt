...
class GridAdapter(
    context: Context,
    private val calendarData: SlyCalendarData,
    shiftMonth: Int,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (calendarData.getSelectedStartDate() != null) {
            ...
            calendarStart.time = calendarData.getSelectedStartDate()!!
        ...
        if (calendarData.getSelectedEndDate() != null) {
            ...
            calendarEnd.time = calendarData.getSelectedEndDate()
        ...
        view.findViewById<View>(R.id.cellView).setOnClickListener {
            ...
            if (listener != null) listener.dateSelect(selectedDate.time)
        ...
        view.findViewById<View>(R.id.cellView).setOnLongClickListener {
            ...
            selectedDate[Calendar.SECOND] = 0
            selectedDate[Calendar.MILLISECOND] = 0
            if (listener != null) listener.dateLongSelect(monthlyDates[position])
            notifyDataSetChanged()
            gridListener.gridChanged()
            true
        }
        view.findViewById<View>(R.id.cellView)
            .setBackgroundColor(calendarData.getBackgroundColor()!!)
        if (calendarStart != null && calendarEnd != null) {
            if (dateCal[Calendar.DAY_OF_YEAR] == calendarStart[Calendar.DAY_OF_YEAR] && dateCal[Calendar.YEAR] == calendarStart[Calendar.YEAR]) {
                ...
                var shape = (ContextCompat.getDrawable(
                    context, R.drawable.slycalendar_middle_day
                ) as LayerDrawable?)!!
                (shape.findDrawableByLayerId(R.id.dateShapeItem) as GradientDrawable).setColor(
                    calendarData.getSelectedColor()!!
                )
                ...
                val shape = (ContextCompat.getDrawable(
                    context, R.drawable.slycalendar_end_day
                ) as LayerDrawable?)!!
                (shape.findDrawableByLayerId(R.id.dateShapeItem) as GradientDrawable).setColor(
                    calendarData.getSelectedColor()!!
                )
        ...
        currentDate.time = calendarData.getShowDate()!!
        ...
        if (calendarStart != null && dateCal[Calendar.DAY_OF_YEAR] == calendarStart[Calendar.DAY_OF_YEAR] && currentDate[Calendar.MONTH] == dateCal[Calendar.MONTH] && dateCal[Calendar.YEAR] == calendarStart[Calendar.YEAR]) {
            val shape = (ContextCompat.getDrawable(
                context, R.drawable.slycalendar_selected_day
            ) as LayerDrawable?)!!
            ...
            (view.findViewById<View>(R.id.txtDate) as TextView).setTextColor(
                calendarData.getSelectedTextColor()!!
            )
            (view.findViewById<View>(R.id.txtDate) as TextView).setTypeface(
                Typeface.create(
                    "sans-serif-medium",
                    Typeface.NORMAL
                )
    ...
    private fun init() {
        ...
        calendar.time = calendarData.getShowDate()
