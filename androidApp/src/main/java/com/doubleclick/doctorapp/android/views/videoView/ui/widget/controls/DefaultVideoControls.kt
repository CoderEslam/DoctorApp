...
import com.doubleclick.doctorapp.android.views.videoView.ui.listener.VideoControlsButtonListener
import com.doubleclick.doctorapp.android.views.videoView.ui.listener.VideoControlsSeekListener
import com.doubleclick.doctorapp.android.views.videoView.ui.listener.VideoControlsVisibilityListener
import com.doubleclick.doctorapp.android.views.videoView.ui.widget.VideoView
import com.doubleclick.doctorapp.android.views.videoView.util.Repeater
import com.doubleclick.doctorapp.android.views.videoView.util.millisToFormattedDuration
import com.doubleclick.doctorapp.android.views.videoView.util.tintListCompat
...
abstract class DefaultVideoControls : RelativeLayout, VideoControls, OnTimelineChangedListener {
  ...
  protected open fun updateButtonDrawables(@ColorRes tintList: Int) {
    playDrawable = context.tintListCompat(
      R.drawable.exomedia_ic_play_arrow_white,
      tintList
    )
    pauseDrawable = context.tintListCompat(
      R.drawable.exomedia_ic_pause_white,
      tintList
    )
    playPauseButton.setImageDrawable(playDrawable)

    val previousDrawable = context.tintListCompat(
      R.drawable.exomedia_ic_skip_previous_white,
      tintList
    )
    previousButton.setImageDrawable(previousDrawable)

    val nextDrawable = context.tintListCompat(
      R.drawable.exomedia_ic_skip_next_white,
      tintList
    )
   ...
   * VideoControls
   */
  protected open inner class InternalListener : VideoControlsSeekListener,
