...
class BubbleNavigationConstraintView : ConstraintLayout, View.OnClickListener,
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        if (mode >= 0 && mode < BubbleNavigationConstraintView.DisplayMode.values().size) displayMode =
            BubbleNavigationConstraintView.DisplayMode.values()
                .get(mode)
    ...
    private fun createChains() {
        ...
        for (i in bubbleNavItems!!.indices) {
            val id: Int = bubbleNavItems!![i].getId()
            chainIdsList[i] = id
    ...
    /**
     * Sets [View.OnClickListener] for the child views
     */
    ...
    private fun getItemPositionById(id: Int): Int {
        for (i in bubbleNavItems!!.indices) if (id == bubbleNavItems!![i].getId()) return i
        return -1
    }
    ///////////////////////////////////////////
    // PUBLIC METHODS
