package com.doubleclick.doctorapp.android.views.onboarder
...
import com.doubleclick.doctorapp.android.views.onboarder.utils.ShadowTransformer
import com.doubleclick.doctorapp.android.views.onboarder.views.CircleIndicatorView
import com.doubleclick.doctorapp.android.views.onboarder.views.FlowingGradientClass

/**
 * Created By Eslam Ghazy on 12/31/2022
 */
abstract class AhoyOnboarderActivity : AppCompatActivity(),
    ...
    override fun onClick(v: View) {
        ...
        if (i == R.id.btn_skip && isInLastPage) {
            ...
            vpOnboarderPager.setCurrentItem(vpOnboarderPager.currentItem - 1)
    ...
    override fun onPageSelected(position: Int) {
        ...
        val lastPagePosition: Int = ahoyOnboarderAdapter.count - 1
