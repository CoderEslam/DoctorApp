package com.doubleclick.doctorapp.android.views.smarttablayout
 ...
 */
class SmartTabStrip(context: Context, attrs: AttributeSet?) :
    ...
    private val indicatorAlwaysInCenter: Boolean
    ...
    init {
        ...
        var indicationInterpolatorId = SmartTabIndicationInterpolator.ID_SMART
        ...
        a.recycle()
        val indicatorColors =
            if (indicatorColorsId == NO_ID) intArrayOf(indicatorColor) else resources.getIntArray(
                indicatorColorsId
            )
        val dividerColors =
            if (dividerColorsId == NO_ID) intArrayOf(dividerColor) else resources.getIntArray(
                dividerColorsId
            )
